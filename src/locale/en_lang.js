export default {
  ...
  home: {
    title: `NFTS
          FOR EVERYONE`,
    description:
      "Mint, Explorer, and storage NFTs for a fraction of Ethereum  mainnet  costs. ",
    descriptions: "MINTBOX makes mint fast, cheap, and secure.",
    createBtn: "CREATE",
    ...
    useMintBoxTitle: "MINTBOX",
    useMintBox: "Use description",
  ...
  create: {
    ...
    supportMultipleNumberNft: "Support for issuing multiple numbers of NFTs",
  },
  upload: {
    ...
    logoUploadTips: "We recommend an image of at least 300x300. Gifs work too.",
